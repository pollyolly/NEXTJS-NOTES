...
interface CarDetailsProps {
    isOpen: boolean;
    closeModal: ()=> void; //function does not return anything
    car: CarCardProps      //reusing/extending existing Interface or Types
}
                        ...
                        <div className="flex min-h-full items-center justify-center p-4 text-center">
                            <Transition.Child
                                ...
                                leaveTo="opacity-0 scale-95">
                                    ...
                                    transform rounded-2xl bg-white text-left p-6
                                    shadow-xl transition-all flex flex-col gap-5">
                                        ...
                                        <div className="flex-1 flex flex-col gap-2">
                                            ...
                                            <div className="mt-3 flex flex-wrap gap-4">
                                                {/* Note: Get keys and values in Javascript */}
                                                {
